...
export const Video = (props: VideoProps) => {
  ...
  return (
    <div className="flex-1 overflow-y-scroll no-scrollbar">
      ...
      <div className="p-8 pb-20 max-w-[1100px] mx-auto">
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col w-full lg:w-auto justify-around gap-4">
            ...
            <a href="" className="p-4 text-sn border border-blue-500 text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 hover:text-gray-900 transition-colors">
              <Lightning size={24}/>
              Acesse o desafio
            </a>
          </div>
          ...
          <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors" >
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="text-gray-200 mt-2">
                Baixe wallpapers exclusivos do Ingnite Lab e personalize a sua máquina
              </p>
            </div>
